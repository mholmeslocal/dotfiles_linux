...
-- Get XMonad and XMobar to talk to each other
...
--
myNormalBorderColor  = "#1D202F"
myFocusedBorderColor = "#9D7CD8"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_p     ), spawn "dmenu_run -nb '#1e1e1e' -sf '#1e1e1e' -sb '#9D7CD8' -nf '#9D7CD8' -fn 'MesloLGS NF-10'")
...
--
myLayout = avoidStruts (spacing 8 tiled ||| Mirror tiled ||| spacing 8 Full ||| spacing 8 threeCol)
  where
     -- tiling algorithm partitions the screen into three panes
